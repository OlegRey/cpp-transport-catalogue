...
std::optional<bus_catalog::BusStat> RequestHandler::GetBusStat(const std::string_view bus_number) const {
    bus_catalog::BusStat bus_stat{};
    const bus_catalog::Bus* bus = catalogue_.FindRoute(bus_number);
