...
namespace request_handler {
    ...
    std::optional<RouteInfo> RequestHandler::get_route_info(std::string_view start,
        ...
        return routing.get_route_info(routing.get_router_by_stop(catalogue.get_stop(start))->bus_wait_begin,
            routing.get_router_by_stop(catalogue.get_stop(end))->bus_wait_begin);
    }
