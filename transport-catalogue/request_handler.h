...
public:
    RequestHandler(const bus_catalog::Catalogue& catalogue, const renderer::MapRenderer& renderer, const bus_catalog::Router& router)
    ...
    std::optional<bus_catalog::BusStat> GetBusStat(const std::string_view bus_number) const;
...
private:
    const bus_catalog::Catalogue& catalogue_;
    const renderer::MapRenderer& renderer_;
    const bus_catalog::Router& router_;
};